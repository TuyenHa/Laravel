...
<div class="td-main-content-wrap">
    ...
    <div class="td-container td-blog-index <?php echo $td_sidebar_position; ?>">
        ...
        <img src="https://www.suachuadienlanh.com/upload/slideshow/1492687231banner-sua-may-giat.jpg" width="1170px" style="text-align: center;" />
            <h2>Dịch vụ sửa chữa điện lạnh tại Hà Nội</h2>
        </div>
        <div class="td-pb-row">
            <?php
